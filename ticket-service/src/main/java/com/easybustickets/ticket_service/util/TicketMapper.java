package com.easybustickets.ticket_service.util;
...
import com.easybustickets.ticket_service.model.PaymentStatus;
    ...
    public Mono<TicketInfoResponse> convertToTicketInfoResponse(Mono<Ticket> ticketMono,
        ...
        return Mono.zip(ticketMono, routeMono, paymentMono)
                .map(tuple -> {
                    ...
                    if (!payment.getStatus().equals(PaymentStatus.DONE.name())) {
